...
public class AboutFrame extends JFrame{
	 ...
	 */
	public AboutFrame(RadQCFrame mf) {
		...
		jLabel1.setForeground(RadQCFrame.foreColor);
		jLabel2.setForeground(RadQCFrame.foreColor);
		lbAuthor.setForeground(RadQCFrame.foreColor);
		lbVersion.setForeground(RadQCFrame.foreColor);
		jLabel7.setForeground(RadQCFrame.foreColor);
		textLicense.setBackground(RadQCFrame.textAreaBkgColor);
		textLicense.setForeground(RadQCFrame.textAreaForeColor);
	...
	private void createGUI() {
		...
		jPanel1.setBackground(RadQCFrame.bkgColor);
