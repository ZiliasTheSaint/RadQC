...
/**
 * Database for dosimetry in CT 
 * 
 * @author Dan Fulea, 08 May 2015
 */
@SuppressWarnings("serial")
public class SaveViewDBFrameCt extends JFrame implements ActionListener, ItemListener{
	 ...
	 */
	public SaveViewDBFrameCt(DosimetryFrameCt mf){
		this.mf=mf;
	...
	private void save(){
		...
		try {			
			...
			psInsert.setString(4, mf.exam_toSave);
			psInsert.setString(5, mf.CTDI_toSave);
			psInsert.setString(6, mf.CTDIvol_toSave);
			psInsert.setString(7, mf.unc_toSave);
			psInsert.setString(8, mf.DRL_toSave);	
			psInsert.setString(9, mf.resultTest_toSave);		
			psInsert.setString(10, mf.effectiveDose);
			psInsert.setString(11, mf.effectiveDoseUnit);
			psInsert.setString(12, mf.risk);
			psInsert.setString(13, mf.DLP_toSave);
			psInsert.setString(14, mf.FSD_toSave);
			psInsert.setString(15, mf.sliceThickness_toSave);
			psInsert.setString(16, mf.pitch_toSave);
			psInsert.setString(17, mf.rotationAngleIncrement_toSave);
			psInsert.setString(18, mf.fanBeam_toSave);
			psInsert.setString(19, mf.phantomSex_toSave);
			psInsert.setString(20, mf.phantomMass_toSave);
			psInsert.setString(21, mf.phantomHeight_toSave);
			psInsert.setString(22, mf.phantomAge_toSave);
			psInsert.setString(23, mf.kv_toSave);
			psInsert.setString(24, mf.filtration_toSave);
			psInsert.setString(25, mf.anodeAngle_toSave);
			psInsert.setString(26, mf.ripple_toSave);			
