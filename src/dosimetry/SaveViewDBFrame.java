...
/**
 * Database for dosimetry in radiography
 * 
...
public class SaveViewDBFrame extends JFrame implements ActionListener, ItemListener{
	 ...
	 */
	public SaveViewDBFrame(DosimetryFrame mf){
		this.mf=mf;
	...
	/**
	 * Sorts data from radiography table
	 */
	private void sort() {
	...
	private void save(){
		...
		try {			
			...
			psInsert.setString(5, mf.projection_toSave);
			psInsert.setString(6, mf.ESAK_toSave);
			...
			psInsert.setString(13, mf.KAP_toSave);
			psInsert.setString(14, mf.KAIR_toSave);
			psInsert.setString(15, mf.FSD_toSave);
			psInsert.setString(16, mf.phantomSex_toSave);
			psInsert.setString(17, mf.phantomMass_toSave);
			psInsert.setString(18, mf.phantomHeight_toSave);
			psInsert.setString(19, mf.phantomAge_toSave);
			psInsert.setString(20, mf.kv_toSave);
			psInsert.setString(21, mf.filtration_toSave);
			psInsert.setString(22, mf.anodeAngle_toSave);
			psInsert.setString(23, mf.ripple_toSave);
