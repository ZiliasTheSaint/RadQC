...
public class AboutFrame extends JFrame {
	 ...
	 * @param mf the MTF object
	 */
	public AboutFrame(MTF mf) {
		super("About");
		this.mf = mf;
		resources = ResourceBundle.getBundle(BASE_RESOURCE_CLASS);
		this.setResizable(false);
		
		jLabel1.setForeground(MTF.foreColor);
		jLabel2.setForeground(MTF.foreColor);
		lbAuthor.setForeground(MTF.foreColor);
		lbVersion.setForeground(MTF.foreColor);
		jLabel7.setForeground(MTF.foreColor);
		textLicense.setBackground(MTF.textAreaBkgColor);
		textLicense.setForeground(MTF.textAreaForeColor);
	...
	private void createGUI() {
		...
		jPanel1.setBackground(MTF.bkgColor);
		...
		jPanel3.setBackground(MTF.bkgColor);
		...
		jPanel2.setBackground(MTF.bkgColor);
