...
/**
 * Class for tube output resources
 * 
 * @author Dan Fulea, 01 May 2015
 */
public class OutputFrameResources extends ListResourceBundle{
	...
	private static final Object[][] CONTENTS = {
			...
			{ "OutputFrame.NAME", "Tube output, output repeatability and mAs linearity" },
			{"output.tab.title", "Output"},
			{"reprod.tab.title", "Repeatability (e.g. Dose indicator at fixed settings)"},
	        {"linearity.tab.title", "mAs linearity"},
			//---------------			
			...
			{ "rep.border", "Repeatability" },
			{ "lin.border", "mAs linearity" },
	        ...
	        { "nosave.rep.error.message", "Please perform repeatability test!" },
	        { "nosave.lin.error.message", "Please perform mAs linearity test!" },	        
