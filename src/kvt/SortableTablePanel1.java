...
/**
 * Create a sortable table panel. This is supposed to be slightly different than 
 * SortableTablePanel but ended up as a clone..for now. 
 * 
 * @author DanFulea, 22 Mar. 2005
 */
@SuppressWarnings("serial")
public class SortableTablePanel1 extends JPanel{
	...
	private Vector headerVector= new Vector();
	  ...
	  /**
		 ...
		 */
	  public SortableTablePanel1(Object[][] dataObj,String[] headerStr)
	  {
	...
	public SortableTablePanel1(Vector dataVector, Vector headerVector)
	  {
	...
	/*  public static void main(String[] args)
		{
	    	...
	    	f.getContentPane().add(new SortableTablePanel1(), BorderLayout.CENTER);
	    	f.setSize(400, 160);
	    	f.setVisible(true);
